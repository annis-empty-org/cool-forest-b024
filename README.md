...
```
npm create cloudflare@latest -- --template=cloudflare/templates/cool-forest-b024
```

## Preview Deployment

A live public deployment of this template is available at [https://cool-forest-b024.templates.workers.dev](https://cool-forest-b024.templates.workers.dev)
